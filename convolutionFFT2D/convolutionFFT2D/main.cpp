...
bool test0(void)
{
    ...
    *d_KernelSpectrum;
    ...
    const long int   dataH = DATA_H;
    const long int   dataW = DATA_W;
    ...
    printf("...uploading to GPinit_data_stopU and padding convolution kernel and input data\n");
    h2d_memcpy_start = cufft_init_stop;
